...
from .htmx_views import (
    ...
    project_memberships_panel,
    project_membership_add,
    ...
    workflow_delete,
    bulk_analysis_create_form,
    bulk_analysis_create_modal,
    bulk_analysis_pipeline_options,
    bulk_analysis_test_options,
    bulk_variant_analysis_options,
    bulk_variant_create_form,
    bulk_variant_create_modal,
    bulk_variant_pipeline_options,
    bulk_variant_test_options,
    bulk_sample_create_form,
    bulk_sample_create_modal,
    bulk_pipeline_create_form,
    bulk_pipeline_create_modal,
    bulk_pipeline_test_options,
    bulk_test_create_form,
    bulk_test_create_modal,
...
urlpatterns = [
    ...
    path("htmx/bulk-create/samples/", bulk_sample_create_modal, name="bulk_sample_create_modal"),
    path("htmx/bulk-create/samples/form/", bulk_sample_create_form, name="bulk_sample_create_form"),
    path("htmx/bulk-create/tests/", bulk_test_create_modal, name="bulk_test_create_modal"),
    path("htmx/bulk-create/tests/form/", bulk_test_create_form, name="bulk_test_create_form"),
    path("htmx/bulk-create/pipelines/", bulk_pipeline_create_modal, name="bulk_pipeline_create_modal"),
    path("htmx/bulk-create/pipelines/form/", bulk_pipeline_create_form, name="bulk_pipeline_create_form"),
    path("htmx/bulk-create/pipelines/test-options/", bulk_pipeline_test_options, name="bulk_pipeline_test_options"),
    path("htmx/bulk-create/analyses/", bulk_analysis_create_modal, name="bulk_analysis_create_modal"),
    path("htmx/bulk-create/analyses/form/", bulk_analysis_create_form, name="bulk_analysis_create_form"),
    path("htmx/bulk-create/analyses/test-options/", bulk_analysis_test_options, name="bulk_analysis_test_options"),
    path("htmx/bulk-create/analyses/pipeline-options/", bulk_analysis_pipeline_options, name="bulk_analysis_pipeline_options"),
    path("htmx/bulk-create/variants/", bulk_variant_create_modal, name="bulk_variant_create_modal"),
    path("htmx/bulk-create/variants/form/", bulk_variant_create_form, name="bulk_variant_create_form"),
    path("htmx/bulk-create/variants/test-options/", bulk_variant_test_options, name="bulk_variant_test_options"),
    path("htmx/bulk-create/variants/pipeline-options/", bulk_variant_pipeline_options, name="bulk_variant_pipeline_options"),
    path("htmx/bulk-create/variants/analysis-options/", bulk_variant_analysis_options, name="bulk_variant_analysis_options"),
    ...
    path("htmx/project/<int:pk>/memberships/", project_memberships_panel, name="project_memberships_panel"),
    path("htmx/project/<int:pk>/memberships/add/", project_membership_add, name="project_membership_add"),
    path("htmx/project/<int:project_pk>/memberships/<int:membership_pk>/update/", project_membership_update, name="project_membership_update"),
    path("htmx/project/<int:project_pk>/memberships/<int:membership_pk>/remove/", project_membership_remove, name="project_membership_remove"),
