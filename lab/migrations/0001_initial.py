    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('example', models.CharField(blank=True, default='', help_text='Example of a valid identifier value for this type.', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_of_onset_in_months', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_download_menu', models.BooleanField(default=True, help_text="Show Marimo's notebook actions/download menu on notebook pages.")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('positive_report_template', models.CharField(blank=True, default='', max_length=255)),
                ('negative_report_template', models.CharField(blank=True, default='', max_length=255)),
                ...
                ('default_total_reads_text', models.CharField(blank=True, default='', max_length=255)),
                ('default_coverage_20x_text', models.CharField(blank=True, default='', max_length=255)),
                ('default_mean_depth_text', models.CharField(blank=True, default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('contact_info', models.JSONField(blank=True, default=list, help_text='Ordered clinician contact values imported from spreadsheets.')),
                ...
                ('signer_block_text', models.TextField(blank=True, default='', help_text='Multiline signer block inserted into generated reports.')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('performed_by', models.ManyToManyField(blank=True, related_name='analyses_performed', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('analysis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='reports', to='lab.analysis')),
