...
class BulkVariantCreateModalTests(TestCase):
    ...
    def setUp(self):
        ...
        self.project = Project.objects.create(name="Bulk Variant Project", created_by=self.user)
        self.project.individuals.add(self.first, self.second, self.no_analysis)
